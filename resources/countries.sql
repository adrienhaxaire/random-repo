create table countries (code text unique not null, name text not null, primary key (code));
...
insert into countries(code, name) values ('BR', 'Brazil","SA');
...
insert into countries(code, name) values ('BY', 'Belarus","EU');
...
insert into countries(code, name) values ('KS', 'Kosovo');
...
insert into countries(code, name) values ('MM', 'Burma');
...
insert into countries(code, name) values ('PH', 'Philippines","AS');
...
insert into countries(code, name) values ('RE', 'Réunion","AF');
insert into countries(code, name) values ('RO', 'Romania');
insert into countries(code, name) values ('RS', 'Serbia');
insert into countries(code, name) values ('RU', 'Russia","EU","http://en.wikipedia.org/wiki/Russia');
...
insert into countries(code, name) values ('ST', 'São Tomé and Principe');
insert into countries(code, name) values ('SV', 'El Salvador","NA');
...
insert into countries(code, name) values ('TH', 'Thailand","AS');
